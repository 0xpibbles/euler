...
# 1. Query the latest date for Compound from Dune
...
csv_file_path = 'defillama_compound_new.csv'
if new_rows:
    ...
    try:
        with open(csv_file_path, "rb") as data:
            response = dune.insert_table(
                namespace="0xpibs",
                table_name="defillama_compound_arbitrum",
                data=data,
