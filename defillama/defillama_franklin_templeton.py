...
# 1. Query the latest date for Franklin Templeton from Dune
...
csv_file_path = 'defillama_franklin_templeton_new.csv'
if new_rows:
    ...
    try:
        with open(csv_file_path, "rb") as data:
            response = dune.insert_table(
                namespace="0xpibs",
                table_name="defillama_franklin_templeton_arbitrum",
                data=data,
