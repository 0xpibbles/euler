...
# 1. Query the latest date for Camelot from Dune
...
# 2. Fetch API data
url = "https://api.llama.fi/protocol/camelot"
...
csv_file_path = 'defillama_camelot_new.csv'
if new_rows:
    ...
    try:
        with open(csv_file_path, "rb") as data:
            response = dune.insert_table(
                namespace="0xpibs",
                table_name="defillama_camelot_arbitrum",
                data=data,
