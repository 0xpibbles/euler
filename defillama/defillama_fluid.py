...
# 1. Query the latest date for Fluid from Dune
...
# 2. Fetch API data
url = "https://api.llama.fi/protocol/fluid"
...
csv_file_path = 'defillama_fluid_new.csv'
if new_rows:
    ...
    try:
        with open(csv_file_path, "rb") as data:
            response = dune.insert_table(
                namespace="0xpibs",
                table_name="defillama_fluid_arbitrum",
                data=data,
