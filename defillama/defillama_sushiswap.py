...
# 1. Query the latest date for Sushiswap from Dune
...
# 2. Fetch API data
url = "https://api.llama.fi/protocol/sushiswap"
...
csv_file_path = 'defillama_sushiswap_new.csv'
if new_rows:
    ...
    try:
        with open(csv_file_path, "rb") as data:
            response = dune.insert_table(
                ...
                table_name="defillama_sushiswap_arbitrum",
                data=data,
